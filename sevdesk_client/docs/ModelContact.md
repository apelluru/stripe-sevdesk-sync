...
model_contact_instance = ModelContact.from_json(json)
# print the JSON string representation of the object
print(ModelContact.to_json())

# convert the object into a dict
model_contact_dict = model_contact_instance.to_dict()
# create an instance of ModelContact from a dict
model_contact_from_dict = ModelContact.from_dict(model_contact_dict)
```
