...
json = "{}"
# create an instance of BookVoucher200Response from a JSON string
book_voucher200_response_instance = BookVoucher200Response.from_json(json)
# print the JSON string representation of the object
print(BookVoucher200Response.to_json())

# convert the object into a dict
book_voucher200_response_dict = book_voucher200_response_instance.to_dict()
# create an instance of BookVoucher200Response from a dict
book_voucher200_response_from_dict = BookVoucher200Response.from_dict(book_voucher200_response_dict)
```
