...
class TestSaveInvoice(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SaveInvoice:
        ...
        if include_optional:
            return SaveInvoice(
                invoice = openapi_client.models.invoice_model.Invoice model(
                    id = 56, 
                    object_name = 'Invoice', 
                    invoice_number = 'RE-1000', 
                    contact = openapi_client.models.model_invoice_contact.Model_Invoice_contact(
                        id = 56, 
                        object_name = 'Contact', ), 
                    contact_person = openapi_client.models.model_invoice_contact_person.Model_Invoice_contactPerson(
                        id = 56, 
                        object_name = 'SevUser', ), 
                    ...
                    sev_client = openapi_client.models.model_invoice_sev_client.Model_Invoice_sevClient(
                        id = 56, 
...
street
postCode city', 
                    address_country = openapi_client.models.model_invoice_address_country.Model_Invoice_addressCountry(
                        id = 1, 
                        object_name = 'StaticCountry', ), 
                    pay_date = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                    create_user = openapi_client.models.model_credit_note_create_user.Model_creditNote_createUser(
                        id = 56, 
                        object_name = 'SevUser', ), 
                    ...
                    tax_rate = 0, 
                    tax_rule = openapi_client.models.model_credit_note_response_tax_rule.Model_creditNoteResponse_taxRule(
                        id = '1', 
                        object_name = 'TaxRule', ), 
                    tax_text = 'Umsatzsteuer 19%', 
                    tax_type = 'default', 
                    tax_set = openapi_client.models.model_invoice_tax_set.Model_Invoice_taxSet(
                        id = '1', 
                        object_name = 'TaxSet', ), 
                    dunning_level = 56, 
                    payment_method = openapi_client.models.model_invoice_payment_method.Model_Invoice_paymentMethod(
                        id = 21919, 
                    ...
                    send_type = 'VPR', 
                    origin = openapi_client.models.model_invoice_origin.Model_Invoice_origin(
                        id = '1', 
                        object_name = 'Order', ), 
                    customer_internal_note = '', 
                    map_all = True, ),
                invoice_pos_save = [
                    openapi_client.models.invoice_position_model.Invoice position model(
                        id = 56, 
                        object_name = 'InvoicePos', 
                        map_all = True, 
                        create = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        update = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                        invoice = openapi_client.models.model_invoice_pos_invoice.Model_InvoicePos_invoice(
                            id = 56, 
                            object_name = 'Invoice', ), 
                        part = openapi_client.models.model_credit_note_pos_part.Model_creditNotePos_part(
                            id = 56, 
                            object_name = 'Part', ), 
                        quantity = 1, 
                        price = 100, 
                        name = 'Dragonglass', 
                        unity = openapi_client.models.model_invoice_pos_unity.Model_InvoicePos_unity(
                            id = 1, 
                            object_name = 'Unity', ), 
                        sev_client = openapi_client.models.model_invoice_pos_sev_client.Model_InvoicePos_sevClient(
                            id = 56, 
                            object_name = 'SevClient', ), 
                        position_number = 56, 
                        text = '', 
                ...
                invoice_pos_delete = openapi_client.models.save_invoice_invoice_pos_delete.saveInvoice_invoicePosDelete(
                    id = 56, 
                    object_name = '', ),
                filename = bytes(b'blah'),
                discount_save = [
                    openapi_client.models.save_invoice_discount_save_inner.saveInvoice_discountSave_inner(
                        discount = True, 
                        text = '', 
                        percentage = True, 
                        value = 1.337, 
                ...
                discount_delete = openapi_client.models.save_invoice_discount_delete.saveInvoice_discountDelete(
                    id = 56, 
                    object_name = 'Discounts', )
            )
        else:
