...
from sevdesk_client.openapi_client.exceptions import ApiException, ApiValueError
...
class RESTResponse(io.IOBase):
    ...
    def __init__(self, resp) -> None:
        ...
        logging.debug(f"raw response for request: {self.status} {self.reason} {self.response.data}")
