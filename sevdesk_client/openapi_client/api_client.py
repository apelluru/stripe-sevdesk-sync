...
from sevdesk_client.openapi_client.api_response import ApiResponse, T as ApiResponseT
import sevdesk_client.openapi_client.models
from sevdesk_client.openapi_client import rest
from sevdesk_client.openapi_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(sevdesk_client.openapi_client.models, klass)
