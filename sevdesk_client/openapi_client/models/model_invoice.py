...
class ModelInvoice(BaseModel):
    ...
    def invoice_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['RE', 'WKR', 'SR', 'MA', 'TR', 'ER']):
            raise ValueError("must be one of enum values ('RE', 'WKR', 'SR', 'MA', 'TR', 'ER')")
        return value
