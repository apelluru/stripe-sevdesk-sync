...
class ModelInvoicePos(BaseModel):
    """
    Invoice position model
    """ # noqa: E501
    id: Optional[StrictInt] = Field(default=None, description="The invoice position id. <span style='color:red'>Required</span> if you want to update an invoice position for an existing invoice")
    object_name: StrictStr = Field(description="The invoice position object name", alias="objectName")
    map_all: StrictBool = Field(alias="mapAll")
    create: Optional[datetime] = Field(default=None, description="Date of invoice position creation")
    update: Optional[datetime] = Field(default=None, description="Date of last invoice position update")
    invoice: Optional[ModelInvoicePosInvoice] = None
    part: Optional[ModelCreditNotePosPart] = None
    quantity: Union[StrictFloat, StrictInt] = Field(description="Quantity of the article/part")
    price: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Price of the article/part. Is either gross or net, depending on the sevdesk account setting.")
    name: Optional[StrictStr] = Field(default=None, description="Name of the article/part.")
    unity: ModelInvoicePosUnity
    sev_client: Optional[ModelInvoicePosSevClient] = Field(default=None, alias="sevClient")
    position_number: Optional[StrictInt] = Field(default=None, description="Position number of your position. Can be used to order multiple positions.", alias="positionNumber")
    text: Optional[StrictStr] = Field(default=None, description="A text describing your position.")
    discount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="An optional discount of the position.")
    tax_rate: Union[StrictFloat, StrictInt] = Field(description="Tax rate of the position.", alias="taxRate")
    sum_discount: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Discount sum of the position", alias="sumDiscount")
    sum_net_accounting: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Net accounting sum of the position", alias="sumNetAccounting")
    sum_tax_accounting: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Tax accounting sum of the position", alias="sumTaxAccounting")
    sum_gross_accounting: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gross accounting sum of the position", alias="sumGrossAccounting")
    price_net: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Net price of the part", alias="priceNet")
    price_gross: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Gross price of the part", alias="priceGross")
    price_tax: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Tax on the price of the part", alias="priceTax")
    __properties: ClassVar[List[str]] = ["id", "objectName", "mapAll", "create", "update", "invoice", "part", "quantity", "price", "name", "unity", "sevClient", "positionNumber", "text", "discount", "taxRate", "sumDiscount", "sumNetAccounting", "sumTaxAccounting", "sumGrossAccounting", "priceNet", "priceGross", "priceTax"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of unity
        if self.unity:
            _dict['unity'] = self.unity.to_dict()
        ...
        # set to None if sum_discount (nullable) is None
        # and model_fields_set contains the field
        if self.sum_discount is None and "sum_discount" in self.model_fields_set:
            _dict['sumDiscount'] = None

        # set to None if sum_net_accounting (nullable) is None
        # and model_fields_set contains the field
        if self.sum_net_accounting is None and "sum_net_accounting" in self.model_fields_set:
            _dict['sumNetAccounting'] = None

        # set to None if sum_tax_accounting (nullable) is None
        # and model_fields_set contains the field
        if self.sum_tax_accounting is None and "sum_tax_accounting" in self.model_fields_set:
            _dict['sumTaxAccounting'] = None

        # set to None if sum_gross_accounting (nullable) is None
        # and model_fields_set contains the field
        if self.sum_gross_accounting is None and "sum_gross_accounting" in self.model_fields_set:
            _dict['sumGrossAccounting'] = None

        # set to None if price_net (nullable) is None
        # and model_fields_set contains the field
        if self.price_net is None and "price_net" in self.model_fields_set:
            _dict['priceNet'] = None

        # set to None if price_gross (nullable) is None
        # and model_fields_set contains the field
        if self.price_gross is None and "price_gross" in self.model_fields_set:
            _dict['priceGross'] = None

        # set to None if price_tax (nullable) is None
        # and model_fields_set contains the field
        if self.price_tax is None and "price_tax" in self.model_fields_set:
            _dict['priceTax'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "invoice": ModelInvoicePosInvoice.from_dict(obj["invoice"]) if obj.get("invoice") is not None else None,
            "part": ModelCreditNotePosPart.from_dict(obj["part"]) if obj.get("part") is not None else None,
            "quantity": obj.get("quantity"),
            "price": obj.get("price"),
            "name": obj.get("name"),
            "unity": ModelInvoicePosUnity.from_dict(obj["unity"]) if obj.get("unity") is not None else None,
            "sevClient": ModelInvoicePosSevClient.from_dict(obj["sevClient"]) if obj.get("sevClient") is not None else None,
            "positionNumber": obj.get("positionNumber"),
            "text": obj.get("text"),
            "discount": obj.get("discount"),
            "taxRate": obj.get("taxRate"),
            "sumDiscount": obj.get("sumDiscount"),
            ...
            "priceNet": obj.get("priceNet"),
            "priceGross": obj.get("priceGross"),
            "priceTax": obj.get("priceTax")
        })
        return _obj
