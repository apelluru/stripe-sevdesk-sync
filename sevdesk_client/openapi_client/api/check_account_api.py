...
from sevdesk_client.openapi_client.api_client import ApiClient, RequestSerialized
from sevdesk_client.openapi_client.api_response import ApiResponse
from sevdesk_client.openapi_client.rest import RESTResponseType
...
class CheckAccountApi:
    ...
    def create_check_account(
        self,
        model_check_account: Annotated[Optional[ModelCheckAccount], Field(description="Creation data. Please be aware, that you need to provide at least all required parameter      of the CheckAccount model!")] = None,
        ...
        """(Deprecated) Create a new check account

        Creates a new banking account on which transactions can be created.

        :param model_check_account: Creation data. Please be aware, that you need to provide at least all required parameter      of the CheckAccount model!
        :type model_check_account: ModelCheckAccount
        ...
        """ # noqa: E501
        warnings.warn("POST /CheckAccount is deprecated.", DeprecationWarning)

        _param = self._create_check_account_serialize(
            model_check_account=model_check_account,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "GetCheckAccounts200Response",
            '400': None,
            '401': None,
            '500': None,
        }
    ...
    @validate_call
    def create_check_account_with_http_info(
        self,
        model_check_account: Annotated[Optional[ModelCheckAccount], Field(description="Creation data. Please be aware, that you need to provide at least all required parameter      of the CheckAccount model!")] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_check_account_without_preload_content(
        self,
        model_check_account: Annotated[Optional[ModelCheckAccount], Field(description="Creation data. Please be aware, that you need to provide at least all required parameter      of the CheckAccount model!")] = None,
        _request_timeout: Union[
            None,
    ...
    def _create_check_account_serialize(
        self,
        model_check_account,
        _request_auth,
        _content_type,
        ...
        if model_check_account is not None:
            _body_params = model_check_account
